                ...
                <div className="flex flex-wrap flex-row justify-between md:mx-24 gap-5">
                    <div className="w-full md:w-auto">
                        ...
                        <div className="flex flex-col md:flex-row justify-center place-items-center md:justify-start gap-5">
                                <button className="btn btn-accent dark:btn-primary" onClick={openURL("mailto:cychandt@connect.ust.hk")}>
                                    <FontAwesomeIcon icon={faEnvelope} />
                                    <p>cychandt@connect.ust.hk</p>
                                </button>
                                <button className="btn btn-accent dark:btn-primary" onClick={openURL("https://www.linkedin.com/in/chung-yuk-chan-6a2742241/")}>
                                    <FontAwesomeIcon icon={faLinkedin} />
                                    <p>LinkedIn</p>
                                </button>
                                <button className="btn btn-accent dark:btn-primary" onClick={openURL("https://github.com/3underscoreN")}>
                    ...
                    <div className="w-full md:w-auto">
                        ...
                        <div className="my-5" />
                        <div className="flex flex-col md:flex-row justify-center place-items-center md:justify-start gap-5">
                                <button className="btn btn-accent dark:btn-primary" onClick={openURL("https://www.instagram.com/f.prime.of.x/")}>
                                    <FontAwesomeIcon icon={faInstagram} />
                                    <p>Instagram</p>
                                </button>
                                <button className="btn btn-accent dark:btn-primary" onClick={openURL("https://www.facebook.com/chungyuk.chan.5")}>
